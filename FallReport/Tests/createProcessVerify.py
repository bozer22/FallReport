...
# Click resident button
        ...
        self.driver.find_element_by_id("date").send_keys("08/08/2022")
    ...
    # Navigate to 'https://app.aspireci.com/'
        ...
        # Click 'Open Fall Events' dropdown
        self.driver.find_element_by_xpath("//select[@class='svelte-1jf0zp4']").click()
        time.sleep(3)

        # Select patient to process
        self.driver.find_element_by_xpath("//option[@value='[object Object]'][1]").click()
